...
$(document).ready(function () {
  ...
  $.ajax('http://localhost:5000/api/v1/users/' +  user_id + '/pets', {
    ...
    $('.button-add-collar').click( (buttonElement) => {
      let petId = buttonElement.currentTarget.dataset.petId
      let userId = buttonElement.currentTarget.dataset.userId

      // Get the value of collar
      let inputElement = document.querySelector('.pet-id-' + petId)
      let collarId = inputElement.value
